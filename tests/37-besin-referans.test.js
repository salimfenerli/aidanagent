...
const REF = {
  ...
  // 22 Eyl 2026: 'Yulaf ezmesi' = KURU yulaf (USDA FDC 173904); lapa ayri satir.
  'Yulaf ezmesi':                            [379, 13.2, 67.7, 6.5, 52, 4.3, 0, 10.1],
  'Yulaf lapası (suyla)':                    [71, 2.5, 12, 1.5, 9, 0.9, 0, 1.7],
  // CIG / KURU olcum satirlari — USDA FoodData Central, myfooddata.com ile
  // 22 Eyl 2026'da tek tek dogrulandi (FDC id yaninda).
  'Tavuk göğsü (çiğ)':                       [120, 22.7, 0, 2.6, 5, 0.4, 0, 0],      // 171077
  'Dana kıyma (çiğ)':                        [215, 18.6, 0, 15.1, 12, 2.1, 0, 0],    // 171796
  'Makarna (kuru)':                          [371, 13.1, 74.7, 1.5, 21, 3.3, 0, 3.2],// 169736
  'Bulgur (kuru)':                           [342, 12.3, 75.9, 1.4, 35, 2.5, 0, 12.5],// 170688
  'Kırmızı mercimek (kuru)':                 [358, 23.9, 63.1, 2.2, 48, 7.4, 0, 10.8],// 174284
  'Yeşil mercimek (kuru)':                   [353, 24.6, 63.3, 1.0, 35, 6.5, 0, 10.6],// 172420
  'Nohut (kuru)':                            [378, 20.5, 63, 6.0, 57, 4.3, 0, 12.2], // 173756
  'Kuru fasulye (pişmemiş)':                 [333, 23.3, 60.1, 0.8, 240, 10.4, 0, 15.2],// 175202
  'Kinoa (kuru)':                            [368, 14.1, 64.2, 6.1, 47, 4.6, 0, 7],  // 168874
  'Patates (çiğ)':                           [77, 2, 17.5, 0.1, 12, 0.8, 0, 2.1],    // 170026
  'Labne (light)':                           [145, 7, 5, 10.5, 150, 0.1, 0, 0],      // Pınar etiketi: protein 6,8
